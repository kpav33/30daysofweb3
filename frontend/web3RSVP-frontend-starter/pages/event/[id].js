  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="relative py-12">
        {/* Show an alert based on the status of the user's contract transaction */}
        {loading && (
          <Alert
            alertType={"loading"}
        ...
        <div className="flex flex-wrap-reverse lg:flex-nowrap">
          ...
          <div className="max-w-xs w-full flex flex-col gap-4 mb-6 lg:mb-0">
            {/* Only show for users that havent already RSVP-ed, if they have show link to the event, if event over inform its over */}
