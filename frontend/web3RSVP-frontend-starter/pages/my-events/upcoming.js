...
// Only fetch future events where the eventOwner is equal to the wallet address of the user, we use the where keyword in combination with the _gt modifier
